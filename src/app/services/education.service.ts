...
export class EducationService {
  ...
  public addEducation(education: Education): Observable<Education> {
    return this.http.post<Education>(this.apiServerUrl + `/educations/add`, education);
  }

  public deleteEducationById(id: number): Observable<Education> {
    return this.http.delete<Education>(this.apiServerUrl + `/educations/delete/${id}`);
  }

  public updateEducation(education: Education): Observable<Education> {
    return this.http.put<Education>(this.apiServerUrl + `/educations/update`, education);
  }
}
